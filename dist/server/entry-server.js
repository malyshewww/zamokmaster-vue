...
function ssrRender$7(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<!--[--><div class="header__location location-header"><div class="location-header__current">${ssrInterpolate($options.getCityStorage())}</div><div class="${ssrRenderClass([[$data.isShowLocation && !$props.isHidden ? "active" : ""], "location-header__choice"])}"><div class="location-header__header">Ваш город <span>${ssrInterpolate($options.getCityStorage())}?</span></div><div class="location-header__buttons"><button class="location-header__button btn" type="button">Верно</button><button class="location-header__button btn btn-border" type="button">Выбрать другой</button></div></div></div>`);
...
const _sfc_main$7 = {
  ...
  methods: {
    ...
    replaceCityStorage(city) {
      ...
      this.$emit("update:defaultCity", this.localCity);
    },
    getCityStorage() {
...
const _imports_2 = "/assets/logo-pc-BO9A8ia2.svg";
const _imports_1$1 = "/assets/logo-mobile-JO72Z_6i.svg";
function ssrRender$6(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(ssrRenderComponent(_component_router_link, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<picture${_scopeId}><source${ssrRenderAttr("srcset", _imports_2)} media="(min-width: 767.98px)"${_scopeId}><source${ssrRenderAttr("srcset", _imports_1$1)} media="(min-width: 300px)"${_scopeId}><img${ssrRenderAttr("src", _imports_2)} alt="логотип"${_scopeId}></picture>`);
      } else {
        return [
  ...
  _push(ssrRenderComponent(_component_HeaderLocation, {
    ...
    onToggleCity: _ctx.changeCity,
    defaultCity: $data.localCity
  }, null, _parent));
  _push(`<button class="header__burger" type="button"><span></span></button>${ssrInterpolate($data.localCity)}</div></div></div></header><div class="overlay"></div><!--]-->`);
}
const _sfc_main$6 = {
  components: { Navbar, HeaderLocation },
  emits: ["defaultCity", "onChangeCity"],
  data() {
    return {
      isHidden: false,
      localCity: this.defaultCity
...
const _imports_0 = "/assets/footer-logo-Blr8kxpZ.svg";
const _imports_1 = "/assets/footer-logo-mob-DbATDMM5.svg";
const _imports_3 = "/assets/company-logo-Dd4fV8Ld.svg";
function ssrRender$4(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<!--[--><footer class="footer"><div class="footer__main main-footer"><div class="container"><div class="main-footer__body"><div class="menu-footer__actions"><div class="menu-footer__logo"><picture><source${ssrRenderAttr("srcset", _imports_0)} media="(min-width: 767.98px)"><source${ssrRenderAttr("srcset", _imports_1)} media="(min-width: 300px)"><img${ssrRenderAttr("src", _imports_2)} alt="логотип"></picture></div><button class="btn" type="button"><span>Заказать звонок</span></button></div><div class="main-footer__menu menu-footer" data-spollers><!--[-->`);
...
function ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "wrapper" }, _attrs))}>${ssrInterpolate($data.defaultCity)}`);
  _push(ssrRenderComponent(_component_TheHeader, {
    defaultCity: $data.defaultCity,
    onChangeCity: $options.onChangeCity
  }, null, _parent));
