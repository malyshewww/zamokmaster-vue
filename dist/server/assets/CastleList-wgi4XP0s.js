...
function ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div class="top-main__content"><div class="top-main__body"><h1 class="top-main__title page-title">Вскрытие всех видов замков <span>${ssrInterpolate($props.declensionCity)}</span></h1><p class="top-main__sub-title">Профессиональное вскрытие замков. Официально, предоставляем все документы</p></div><a class="btn-phone btn" href="tel:+79958881086"><div class="btn-phone__text">+7 (995) 888-10-86</div><div class="btn-phone__icon"></div></a></div></div></div><div class="page__body"><div class="container"><div class="castle-list__body page-layout"><div class="castle-list__categories section-groups"><!--[-->`);
