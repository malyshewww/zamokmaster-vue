...
function ssrRender$6(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  ssrRenderList($props.count, (item) => {
    _push(ssrRenderComponent(_component_router_link, {
      ...
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(`<div class="services-slider__image"${_scopeId}><picture${_scopeId}><source${ssrRenderAttr("srcset", "./images/service-detail/" + $props.imagePath + "/logo-" + item + ".png")}${_scopeId}><img${ssrRenderAttr("src", "./images/service-detail/" + $props.imagePath + "/logo-" + item + ".png")} loading="lazy" alt="фото"${_scopeId}></picture></div>`);
        } else {
          return [
            createVNode("div", { class: "services-slider__image" }, [
              createVNode("picture", null, [
                createVNode("source", {
                  srcset: "./images/service-detail/" + $props.imagePath + "/logo-" + item + ".png"
                }, null, 8, ["srcset"]),
                createVNode("img", {
                  src: "./images/service-detail/" + $props.imagePath + "/logo-" + item + ".png",
                  loading: "lazy",
                  alt: "фото"
                }, null, 8, ["src"])
              ])
